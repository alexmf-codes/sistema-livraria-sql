...
1. Abra seu cliente MySQL (ex: MySQL Workbench, DBeaver).
2. Execute o script contido no arquivo principal de instalação (ou copie o código abaixo):
...
-- Para popular a estrutura e os dados automaticamente, execute o arquivo:
-- 00_script_instalacao_rapida.sql (ou o bloco de código unificado disponibilizado)
